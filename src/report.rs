...
pub fn print_report(folder_path: &str, stats: &FolderStats) {
    ...
    println!();
    println!("Largest File");
    println!("------------------------------------------------------------");
    println!("{}", stats.largest_file_name);
    println!("Size : {}", format_size(stats.largest_file_size));
